...
# Function to generate random redeem codes with "MAS-" prefix
def generate_redeem_code(length=10):
    characters = string.ascii_letters + string.digits
    return 'MAS-' + ''.join(random.choice(characters) for _ in range(length))  # Add "MAS-" prefix to code
...
@bot.message_handler(commands=["masscode"])
